...
[VolumeComponentMenu("Custom/BanDayBloomEffect")]
public class BanDayBloomEffect : VolumeComponent, IPostProcessComponent
{
    ...
    public Vector2Parameter scrollDirection = new Vector2Parameter (Vector2.right, true);
